 ...
 *
 * The implementation is complicated by the fact that both expression
 * 
 * RAND_MAX + 1
 *
 ...
 * -----------------------------------
 * The setRandomSeed function simply forwards its arguments to srand.
 ...
 * ------------------------------------
 * The initRandomSeed function declares a static variable that keeps
 * track of whether the seed has been initialized. The first time
 * initRandomSeed is called, intiliazed is false, so the seed is set
 * to the current time.
 */
